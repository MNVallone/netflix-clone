  ...
  return (
    <div className='hero-bg relative'>
      ...
      <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
        ...
        <p className='mb-4'> Ready to watch? Enter yor email to create or restart your membership.</p>
      ...
      <section className='py-10 bg-black text-white'>
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
          ...
          <div className='flex-1 text-center md:text-left'>
            <h2 className='text-4xl md:test-5xl font-extrabold mb-4'>Enjoy on your TV</h2>
          ...
          <div className='flex-1 relative '>
            ...
            <video className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-53/100 z-0'
            playsInline
            autoPlay={true}
            muted
            loop>
      ...
      <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
          {/*left side*/}
          <div className='flex-1 text-center md:text-left'>
            <h2 className='text-4xl md:test-5xl font-extrabold mb-4'>Watch everywhere</h2>
            <p className='text-lg md:text-xl'>
          ...
          <div className='flex-1 relative overflow-hidden'>
            ...
            <video className='absolute top-2 left-1/2 -translate-x-51/100 translate-y-[2.4em] h-44/100 z-0'
            playsInline
            autoPlay={true}
            muted
            loop>
