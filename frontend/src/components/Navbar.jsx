...
const Navbar = () => {
    const [isMobileOpenUp, setIsMobileOpenUp] = useState(false)
    const {user, logout} = useAuthStore() 

    const toggleMobileMenu = () => setIsMobileOpenUp(!isMobileOpenUp);
    ...
    return (
        <header className='max-w-6xl mx-auto flex flex-wrap items-center justify-between p-4 h-20'>
            <div className='flex items-center gap-10 z-50'>
                ...
                {/* Desktop Items */}
                <div className='hidden sm:flex gap-2 items-center'> {/* Para cualquier pantalla con un ancho menor a 640px se oculta*/}
