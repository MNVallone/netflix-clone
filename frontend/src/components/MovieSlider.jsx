...
const scrollRight = () => {
    ...
    return (
        <section className="bg-black text-white relative px-5 md:px-20"
        ...
        onMouseLeave={() => setShowArrows(false)}>
            ...
            size-12 rounded-full bg-black opacity-50 hover:opacity-75 text-white z-10" onClick={scrollLeft}>
                    <ChevronLeft size={24}/>
                </button>
                <button className="absolute top-1/2 -translate-y-1/2 right-5 md:right-24 flex items-center
                justify-center size-12 rounded-full bg-black opacity-50 hover:opacity-75 text-white z-10" onClick={scrollRight}>
